...
proteins = {"apo": {"name": "apo-ferritin", "diameter": 130}, "ribo80S": {"name": "ribosome", "diameter": 310}}
            ...
            for label in range(2, nclass):
                ...
                try:
                    ...
                    if relion_write_directory is not None:
                        ...
                        tools.write_relion_output(
                            proteinName,
                            None,
                            deepFinderCoords,
                            os.path.join(relion_write_directory, tomoID),
                            pixelSize=1,
                        )
                ...
                tools.write_copick_output(
                    proteinName,
                    tomoID,
                    deepFinderCoords,
                    copick_write_directory,
                    pickMethod=user_id,
                    sessionID=coordinates_session_id,
                )
